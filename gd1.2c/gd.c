...
void gdImageArc(gdImagePtr im, long int cx, long int cy, 
		long int w, long int h, double s, double e, int color)
{
    long int i;
    long int lx = 0, ly = 0;
    double j,wwhh;
    ...
    wwhh=(double)w*(double)w+(double)h*(double)h;
    if (wwhh>=10000.0) {
        if ((e-s)>=360) {
            //int x, y, d;
            x = 0;
            ...
            lx = (cos(3.1415926535897932*s/180.0)*w2) + cx;
            ly = (sin(3.1415926535897932*s/180.0)*w2) + cy;
            for (j=s; (j<=e); j+=100.0/(1.0+sqrt(wwhh))) {
                x=(cos(3.1415926535897932*j/180.0)*w2) + cx;
                y=(sin(3.1415926535897932*j/180.0)*h2) + cy;
                //            if (gdImageBoundsSafe(im,x,y)) {
                if (j != s) {
