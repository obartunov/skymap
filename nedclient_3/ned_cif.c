...
int ned_name_resolver(objname, no_names, cp)
char      *objname;
int       *no_names;
CrossID   **cp;
{
...
int ned_objname_search(obj_no, op, cp)
int     *obj_no;
ObjInfo **op;
CrossID **cp;
{
...
int ned_obj_byname(objname, obj_no, op, cp)
char    *objname;
int     *obj_no;
ObjInfo **op;
CrossID **cp;
...
int ned_obj_nearname(objname, radius, obj_no, op, cp) 
char    *objname;
double   radius;
int     *obj_no;
ObjInfo **op;
...
int ned_obj_nearposn(ra, dec, radius, obj_no, op)
double    ra;
double    dec;
double    radius;
int       *obj_no;
...
int ned_obj_iau(iauformat, style, equinox,
...
int ned_ex_refcode(refcode, refp)
char   *refcode;
NedRef *refp;
{
   int        st;
...
int ned_ref(objname, begin_year, end_year, ref_no, cp, refp)
char    *objname;
int     begin_year;
int     end_year;
int     *ref_no;
...
void ned_free_objp(objp, no_obj)
ObjInfo   *objp;
int        no_obj;
{
   ObjInfo    *tmp_p;
